...
open class MisskeyAPIV11(private val misskeyAPI: MisskeyAPI, private val apiDiff: MisskeyAPIV11Diff): MisskeyAPI by misskeyAPI{
    ...
    override fun createList(createList: CreateList): Call<UserListDTO> = misskeyAPI.createList(createList)
    ...
    override fun showList(listId: ListId): Call<UserListDTO> = misskeyAPI.showList(listId)
    ...
    override fun userList(i: I): Call<List<UserListDTO>> = misskeyAPI.userList(i)
